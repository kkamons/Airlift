...
def genRadZones(radDict):
	...
	# get a list of all radial values
...
def defConstraints(decVars,yVars,bcList,bcCountData):
	...
	for i in range(0,len(yVars)):
		...
		# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
		ySum.SetCoefficient(yVars[i],1) # Change this 1 to a 2 or however many bases
...
def genFigure(solList, radDict, bcCountData):
